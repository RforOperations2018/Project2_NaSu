...
# url2 <- paste0("https://services1.arcgis.com/vdNDkVykv9vEWFX4/arcgis/rest/services/Hydrology_Areas/FeatureServer/0/query?where=1%3D1&outFields=*&outSR=4326&f=json")
# print(url2)
# Hydrology_Areas = rjson::fromJSON(file="https://services1.arcgis.com/vdNDkVykv9vEWFX4/arcgis/rest/services/Hydrology_Areas/FeatureServer/0/query?where=1%3D1&outFields=*&outSR=4326&f=json")
...
head(data.frame(t(sapply(Hydrology_Areas_list,c))))
...
checkboxGroupInput("FEATURECODSelect",
                   "Feature code:",
                   choices = unique(Hydrology_Areas$FEATURECOD),
                   selected = c("410", "420"))
```
